...
const BoxFrame = () => {
  return (
    <>
      <Box
        blueBorderBottom={true}
        colorText="#1a73e8"
        textNavBox="All"
        svg={[
          <svg key="All" focusable="false" viewBox="0 0 24 24">
            <path
              fill="#34a853"
      ...
      <Box
        textNavBox="Videos"
        svg={[
          <svg key="Videos" focusable="false" viewBox="0 0 24 24">
      ...
      <Box
        textNavBox="News"
        svg={[
          <svg key="News" focusable="false" viewBox="0 0 24 24">
      ...
      <Box
        textNavBox="Images"
        svg={[
          <svg key="Images" focusable="false" viewBox="0 0 24 24">
      ...
      <Box
        textNavBox="Maps"
        svg={[
          <svg key="Maps" focusable="false" viewBox="0 0 16 16">
